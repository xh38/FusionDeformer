...
def shade(
    ...
    # elif material['bsdf'] == 'depth':
    #     shaded_col = dr.texture()
    elif material['bsdf'] == 'normal':
        shaded_col = (gb_normal + 1.0)*0.5
        # shaded_col = gb_normal
        # Flip the x-axis positive half-axis of Normal. We find this process helps to alleviate the Janus problem.
        # shaded_col[..., 0][shaded_col[..., 0] > 0] = shaded_col[..., 0][shaded_col[..., 0] > 0] * (-1)
